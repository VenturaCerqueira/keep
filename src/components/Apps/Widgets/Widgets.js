            ...
            <Row className="row-sm">
              <Col xl={3} lg={6} sm={6} className="pe-0 ps-0 border-end">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-0 text-muted">
                    <span className="mb-0 text-danger fs-13 ms-1">
              ...
              <Col xl={3} lg={6} sm={6} className="pe-0 ps-0 border-end">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-0 text-muted">
                    <span className="mb-0 text-success fs-13 ms-1">
      ...
      <Row className="row-sm">
        ...
        <Col md={6} sm={6} xl={3}>
          <Card className="custom-card">
            <Card.Body className="user-card text-center">
              <div className="main-img-user avatar-lg online text-center">
                <img alt="avatar" className="rounded-circle" src={user6} />
              </div>
              <div className="mt-2">
                <h5 className="mb-1">Owen Bongcaras</h5>
                <p className="mb-1 tx-inverse">Web Designer</p>
                <span className="text-muted">
                  <i className="far fa-check-circle text-success me-1"></i>
                  Verified
                </span>
          ...
          <Card className="custom-card">
            <Card.Body className="user-card text-center">
              ...
              <div className="mt-2">
                ...
                <p className="mb-1 tx-inverse">Php Developer</p>
                <span className="text-muted">
                  <i className="far fa-check-circle text-success me-1"></i>
                  Verified
                </span>
              ...
              <Card className="card custom-card our-team">
                <Card.Body>
                  ...
                  <div className="contact-info mb-0 text-center">
                    <Link to="#" className="contact-icon border text-primary me-2">
                ...
                <ul className="task-list">
                  <li>
                    ...
                    <p className="text-muted fs-12">
                      ...
                      <Link to="#" className="font-weight-semibold"> Project Management </Link>
                    </p>
                  </li>
                  <li>
                    ...
                    <p className="text-muted fs-12">
                      ...
                      <Link to="#" className="font-weight-semibold"> AngularJS Template </Link>
                    </p>
                  </li>
                  <li>
                    <i className="task-icon bg-secondary"></i>
                  ...
                  <li>
                    ...
                    <p className="text-muted mb-0 fs-12">
                      ...
                      <Link to="#" className="font-weight-semibold"> Integrated management </Link>
                    </p>
                  </li>
                </ul>
              </div>
