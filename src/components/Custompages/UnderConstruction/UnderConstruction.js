...
import { DayCounter } from "../../../data/Custompages/underconstruction";
  ...
  <Fragment>
    ...
    <div className="page main-signin-wrapper bg-primary construction"  >
      <div className="d-flex header-setting-icon demo-icon fa-spin">
        <Link className="nav-link icon" to="#" onClick={() => Customswitcherdata.Swicherbutton()}>
          <i className="fe fe-settings settings-icon "></i>
        </Link>
      </div>
      <div className="construction1 text-center details text-white" onClick={() => Customswitcherdata.remove()}>
        <div>
          <img
