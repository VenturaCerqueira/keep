              ...
              <Container fluid className="main-container">
                <div className="main-header-left">
                  ...
                  <div className="hor-logo">
                    <Link to="#" className="main-logo" >
                      <img src={require("../../assets/landing/images/logo-light.44d148368ec4aeb5e37b.png").default} className="header-brand-img desktop-logo"
                        alt="logo" />
                ...
                <div className="main-header-center">
                  <div className="responsive-logo">
                    <Link to={`${process.env.PUBLIC_URL}/Dashboard`}><img src={require("../../assets/landing/images/logo-light.44d148368ec4aeb5e37b.png")} className="mobile-logo"
                      alt="lo/o" /></Link>
                    <Link to={`${process.env.PUBLIC_URL}/Dashboard`}><img src={require("../../assets/landing/images/logo-light.44d148368ec4aeb5e37b.png")} className="mobile-logo-dark"
                      alt="logo" /></Link>
                  </div>
                </div>
                    ...
                    <Row>
                      ...
                      <div className="navbar main-sidemenu px-0">
                        <Link className="main-logo" to={`${process.env.PUBLIC_URL}/Dashboard`}>
                          <img src={require("../../assets/landing/images/logo-light.44d148368ec4aeb5e37b.png")} className="header-brand-img desktop-logo"
                            alt="logo" />
                          <img src={require("../../assets/landing/images/logo-light.44d148368ec4aeb5e37b.png")} width="60" height="60"
                            viewBox="0 0 24 24"
                ...
                <Container className="px-sm-0">
                  <Row>
                    <Col xl={6} lg={6} className="animation-zidex pos-relative">
                      <h4 className="fw-semibold mt-7">Gestão Tributária</h4>
                      <h1 className="text-start fw-bold">e-Contrib</h1>

                      <h6 className="pb-3">
                        O e-Contrib é uma solução 100% web, moderna, segura e otimizada para gestão de tributos municipais. Gestão completa desde a criação do tributo, sua arrecadação de forma eletrônica e automatizada, tornando o processo mais eficiente e confiável, assegurando acesso rápido às informações dos contribuintes, proporcionando uma fiscalização mais eficiente e transparente, promovendo a justiça tributária e o cumprimento das obrigações das leis municipais.</h6>



                    </Col>
                    <Col xl={6} lg={6} className="my-auto">
                      <img src={require("../../assets/landing/images/market3 - Copy.png")} alt="market" />
                    </Col>
                  </Row>
                </Container>
              </div>
            ...
            <div className="main-content mt-0">
              <div className="side-app">
                <div className="sptb section bg-white" id="Features">
                  <Container>
                    <Row>
                      <h4 className="text-center fw-semibold landing-card-header">Portal do contribuinte</h4>
                      <span className="landing-title"></span>
                      <h2 className="fw-semibold text-center">Acesse ao portal do contribuinte</h2>
                      <p className="text-default mb-5 text-center">Prezado contribuinte, selecione abaixo o portal do município que deseja acessar</p>
                      <Row className="mt-7">
                        <Col lg={3} md={12}>
                          <Card className="features main-features main-features-1 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              <div class="text-center">
                                <img src={require("../../assets/landing/images/municipio-riachao-do-jacuipe-brasao-simb-brneba0401626301.jpg")} class="logo_entidade" alt="..."></img>
                              </div>
                              <div className="text-left counter-body">
                                <h4 className="fw-bold">Riachão do Jacuípe</h4>
                                <p className="mb-0">Prefeitura Municipal</p>
                        ...
                        <Col lg={3} md={12}>
                          <Card className=" features main-features main-features-2 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              <div class="text-center">
                                <img src={require("../../assets/landing/images/Brasao_apora.jpg")} class="logo_entidade" alt="..."></img>
                              </div>
                              <div className="text-left counter-body">
                                <h4 className="fw-bold">Aporá</h4>
                                <p className="mb-0">Prefeitura Municipal</p>
                              </div>
                            </Card.Body>
                          </Card>
                        ...
                        <Col lg={3} md={12}>
                          <Card className="features main-features main-features-3 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              <div class="text-center">
                                <img src={require("../../assets/landing/images/Brasão_de_Urandi.jpg")} class="logo_entidade" alt="..."></img>
                              </div>
                              <div className="text-left counter-body">
                                <h4 className="fw-bold">Urandi</h4>
                                <p className="mb-0">Prefeitura Municipal</p>
                              </div>
                            </Card.Body>
                          </Card>
                        ...
                        <Col lg={3} md={12}>
                          <Card className="features main-features main-features-4 wow fadeInUp reveal revealleft"
                            ...
                            <Card.Body>
                              <div class="text-center">
                                <img src={require("../../assets/landing/images/Brasão_de_Caetité_(1810).png")} class="logo_entidade" alt="..."></img>
                              </div>
                              <div className="text-left counter-body">
                                <h4 className="fw-bold">Tanquinho</h4>
                                <p className="mb-0">Prefeitura Municipal</p>
                              </div>
                            </Card.Body>
                          </Card>
                ...
                <div className="section bg-landing working-section pb-0" id="About">
                  <Container>
                    <Row>
                      <h4 className="text-center fw-semibold landing-card-header">Sistema</h4>
                      <span className="landing-title"></span>
                      <div className="text-center">
                        <h2 className="text-center fw-semibold">Sobre sistema e-Contrib
                        </h2>
                      </div>
...
0                                <h4 className="mb-3">Contribuinte</h4>
                                <p className="title-desc text-muted">Realiza a gestão e o controle dos cadastros de contribuintes, incluindo pessoas físicas, jurídicas, mobiliários, autônomos, ambulantes e profissionais liberais, de forma simplificada, em um único cadastro. Além disso, gerencia o cadastro de veículos, condutores e proprietários. O sistema possui uma versão atualizada de todos os serviços necessários para o atendimento ao contribuinte. Descubra mais sobre essa ferramenta.</p>
                              </div>
                            </Col>
                          ...
                          <Row className="align-items-center">
                            ...
                            <Col xl={8} lg={6} md={6} sm={12}>
                              ...
                              <div className="working-content content-3">
                                <h4 className="mb-3">Nota Fiscal Eletrônica</h4>
                                <p className="title-desc text-muted">Documento digital que substitui a tradicional nota fiscal em papel, facilitando o processo de emissão e gestão de notas fiscais no setor de serviços. Com a integração ao sistema e-Contrib, as empresas podem emitir, registrar e gerenciar essas notas de forma automatizada e eficiente, com total conformidade tributária.
                                </p>
                                <p className="title-desc text-muted mb-0">Emissão da NFS-e no e-Contrib ocorre de maneira instantânea, garantindo que todas as informações sobre o serviço prestado sejam registradas corretamente, incluindo o cálculo do ISS (Imposto Sobre Serviços).</p>
                              </div>
                          ...
                          <Row className="align-items-center">
                            <Col xl={8} lg={6} md={6} sm={12} className=" myorder-2">
                              <div className="working-content content-4">
                                ...
                                <p className="title-desc text-muted"> Emissão de DAMs com PIX instantâneo permite que os contribuintes realizem pagamentos de tributos, taxas e outras obrigações municipais de forma rápida e automatizada. Esse modelo evita atrasos e melhora a versatilidade do pagamento pelo contribuinte.</p>
                                <p className="title-desc text-muted mb-0">Emissão de PIX via CNAB 750 que é um layout padronizado pela FEBRABAN para emissão de PIX  em grandes quantidades. </p>
                              </div>
                            </Col>
                            <Col xl={4} lg={6} md={6} sm={12} className=" myorder-1">
                      ...
                      <div className="Center-footer">
                        <Row>
                          ...
                          <Col lg={4} sm={12} md={4} className="reveal revealleft">
                            <div>
                              <Link to="index.html"><img loading="lazy" alt="" className="logo mb-0"
                                src={require("../../assets/landing/images/logo_2.png")} width="60" height="60"
                                viewBox="0 0 24 24"
                                className="footer-logo" alt="logo" /></Link> <h2>e-Contrib</h2>
                              <p>Digite seu e-mail e entraremos em contato para enviar mais informações sobre nossa aplicação e como ela pode ser útil em seu município.</p>
                      ...
                      <footer className="main-footer px-0 text-center">
                        <Row>
                          <Col md={12} sm={12}>
                            ...
                            <Link to="https:www.keepinformatica.com.br">Keep Informática - <img src={require("../../assets/landing/images/logo_keep.png")} width="20" height="20"
                              viewBox="0 0 24 24"
                              className="header-brand-img desktop-logo-dark" alt="logo" /></Link>  :: TODOS OS DIREITOS RESERVADOS
                          </Col>
                        </Row>
                      </footer>
                    </Card.Body>
